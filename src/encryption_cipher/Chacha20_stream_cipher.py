...
with open(r"C:\Users\visma\OneDrive\Documents\AMRITA-MTECH\Major Project\code\keystream-henon.txt", 'rb') as key_file:      
    keystream = [int(float(num)) for line in key_file for num in line.split()]
key_bytes = bytes(keystream[:32])
# IV generation
iv = os.urandom(16)
# Opening image 
image_path = r"C:\Users\visma\OneDrive\Documents\AMRITA-MTECH\Major Project\code\images\128 x 128.png"
...
encrypted_image_path = r"C:\Users\visma\OneDrive\Documents\AMRITA-MTECH\Major Project\code\images\128_E3.png"
...
decrypted_image_path = r"C:\Users\visma\OneDrive\Documents\AMRITA-MTECH\Major Project\code\images\128_D3.png"
